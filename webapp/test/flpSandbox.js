		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Test UI5 Application Logging",
									"targetURL": "#comsapdevdemologui5consolelog-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapdevdemologui5consolelog-display": {
								"semanticObject": "comsapdevdemologui5consolelog",
								"action": "display",
								"description": "Test UI5 Application Logging",
								"title": "Test UI5 Application Logging",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sapdev.demo.log.ui5consolelog",
									"url": sap.ui.require.toUrl("com/sapdev/demo/log/ui5consolelog")
								}
							}
						}
					}
